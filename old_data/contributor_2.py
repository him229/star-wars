...
part_num = sys.argv[1]
limit_count_begin = sys.argv[2]
limit_count_end = sys.argv[3]
...
try:
    with open('repo_contributor_data_json.txt', 'r') as f:
        ...
        for key, values in data[int(limit_count_begin):int(limit_count_end)]:
            try:
                ...
                continue
                send_twilio_message('Error in for loop; continued')
